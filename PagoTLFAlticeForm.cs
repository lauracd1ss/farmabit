...
namespace farmabit
{
    public partial class PagoTLFAlticeForm : Form
    {
        public PagoTLFAlticeForm()
        {
            InitializeComponent();
        }
        ...
        private void PagoTLFAlticeForm_Load(object sender, EventArgs e)
        {
        ...
        private void maskedTextBox2_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            string tlf = maskedTextBox2.Text;
        ...
        {
            if (string.IsNullOrWhiteSpace(maskedTextBox2.Text) || string.IsNullOrWhiteSpace(textBox3.Text))
            {
            ...
            VALUES (@Agencia, @NumeroContrato, @MontoTotal, @FechaEmision, @Titular)";
                ...
                ejecutar.Parameters.AddWithValue("@NumeroContrato", maskedTextBox2.Text ?? string.Empty);
